...
import { Target, ArrowRight, TrendingUp, Calendar, Image as ImageIcon, Save, X, DollarSign, FileText, Upload } from 'lucide-react'
...
const AddInitiative = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setValidationErrors({})
      ...
      try {
        const response = await api.post('initiatives', formDataToSend, {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-6 rounded-2xl border border-gray-200">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-800">إضافة مبادرة جديدة</h1>
            <p className="text-gray-600">أضف مبادرة جديدة للجمعية الخيرية</p>
          </div>
        </div>
        <div className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <span className="text-purple-600 font-medium">إضافة مبادرة جديدة</span>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
        <form onSubmit={handleSubmit} className="space-y-8" noValidate>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200">
            <button 
              type="submit" 
              className="flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-xl hover:from-purple-600 hover:to-pink-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            >

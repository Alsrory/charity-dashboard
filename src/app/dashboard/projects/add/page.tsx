...
import { TrendingUp, ArrowRight, Save, X, DollarSign, FileText, Upload, Calendar, Image as ImageIcon, Target } from 'lucide-react'
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-2xl border border-gray-200">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-800">إضافة مشروع جديد</h1>
            <p className="text-gray-600">أدخل تفاصيل المشروع الجديد للنظام</p>
          </div>
        </div>
        <div className="flex items-center gap-2 text-sm text-gray-500">
          ...
          <span className="text-green-600 font-medium">إضافة مشروع جديد</span>
        </div>
      </div>
